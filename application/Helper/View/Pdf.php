...
class Zend_View_Helper_Pdf extends Zend_View_Helper_HtmlElement
{
	public function pdf($content, $nameFile, $save = null, $orientation = 'P', $marges = array(5, 5, 5, 8))
	{		
		/** conversion HTML => PDF */
		include_once("html2pdf_v4.03_php5/html2pdf_v4.03/html2pdf.class.php");
		try{
			$html2pdf = new HTML2PDF($orientation,'A4','en', false, 'ISO-8859-15', $marges);
        ...
        public function pdf2($content, $nameFile, $save = null, $orientation = 'P')
	{		
		/** conversion HTML => PDF */
		include_once("html2pdf_v4.03_php5/html2pdf_v4.03/html2pdf.class.php");
		try{
			$html2pdf = new HTML2PDF($orientation,'A4','en', false, 'ISO-8859-15');
			$html2pdf->SetMargins(0, 0 , 0, 0);
                        $html2pdf->writeHTML($content, false);
