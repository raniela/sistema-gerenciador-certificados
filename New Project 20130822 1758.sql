...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tabela responsável por armazenar os alunos que participam de algum treinamento da consultoria.';
...
INSERT INTO `aluno` (`id_aluno`,`id_cliente`,`id_usuario`,`tx_nome_aluno`,`tx_rg`,`tx_cpf`,`tx_cargo`) VALUES 
 (1,14,21,0x52616E69656C61205269636172646F2043617276616C686F,0x323331323332313332,0x3135362E3831332E3336332D3434,0x50726F6772616D61646F7261);
...
CREATE TABLE `certificado` (
  ...
  `tx_url_logotipo_cabecalho1` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  `tx_alinhamento_logotipo_cabecalho1` char(1) COLLATE utf8_bin DEFAULT NULL,
  `tx_url_logotipo_cabecalho2` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  `tx_alinhamento_logotipo_cabecalho2` char(1) COLLATE utf8_bin DEFAULT NULL,
  `tx_url_logotipo_cabecalho3` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  `tx_alinhamento_logotipo_cabecalho3` char(1) COLLATE utf8_bin DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tabela responsável por armazenar os modelos dos certificados que serão gerados para os alunos.';
...
CREATE TABLE `certificado_emitido` (
  ...
  CONSTRAINT `fk_certificado_emitido_certificado` FOREIGN KEY (`id_certificado`) REFERENCES `mydb`.`certificado` (`id_certificado`),
  CONSTRAINT `fk_certificado_emitido_matricula` FOREIGN KEY (`id_matricula`) REFERENCES `mydb`.`matricula` (`id_matricula`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `cliente` (
  ...
  `tx_isncricao_municipal` varchar(15) COLLATE utf8_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tabela responsável por armazenar os clientes que contratam algum treinamento da consultoria.';
...
INSERT INTO `cliente` (`id_cliente`,`id_usuario`,`tx_telefone_fixo`,`tx_telefone_celular`,`tx_nome_fantasia`,`tx_razao_social`,`tx_inscricao_estadual`,`tx_isncricao_municipal`,`tx_cnpj`,`tx_nome`,`tx_rg`,`tx_profissao`,`tx_cpf`,`tx_email`,`tx_nome_contato`,`tx_tipo_cliente`,`tx_cliente_aluno`) VALUES 
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tabela responsável por armazenar os endereços dos clientes. \nCada cliente terá sempre DOIS endereços, o endereço real e o endereço para correspondência';
...
CREATE TABLE `turma` (
  ...
  CONSTRAINT `fk_turma_treinamento` FOREIGN KEY (`id_treinamento`) REFERENCES `mydb`.`treinamento` (`id_treinamento`)
