	...
	*/
	private function preencheImagem()
	{
		...
		//imagefill( $this->img_temp, 0, 0, $corfundo );
                ...
                imagefilledrectangle($this->img_temp, 0, 0, $this->largura, $this->altura, $transparent);
		//$corfundo = imagecolortransparent($this->img_temp, imagecolorallocate( $this->img_temp, $this->rgb[0], $this->rgb[1], $this->rgb[2] ));
